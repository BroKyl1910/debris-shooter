class Projectile {
    ...
    calculateUpdateVector() {
        ...
        let speed = this.isExplosive == true ? this.explosiveSpeed : this.normalSpeed;
        ...
        if (this.position.x > this.player.position.x) {
            x = Math.sin(correctedAngleX) * speed;
            y = -Math.cos(correctedAngleY) * speed;
